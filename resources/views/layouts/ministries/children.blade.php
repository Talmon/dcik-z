...
@section('content')
    <<div class="card" style="margin-top: -80px; border-top: 2px solid #fff;" data-aos="slide-down">
        ...
        <div class="card-img-overlay text-center text-white" style="font-family: Belleza; padding-top: 200px;">
            ...
            <h3 class="display-3  card-title mt-5" style="background: rgba(241, 3, 3, 0.7);">Children Ministry</h3>
        </div>
    </div>
    ...
    <div class="container mx-auto" style="" data-aos="zoom-in">
        <div class="">
            ...
            <div class="row featurette py-5 ">
                ...
                <div class="col-md-5 order-1">
                    <img class="featurette-image img-fluid mx-auto" src="https://cedargrovebc.files.wordpress.com/2014/12/childrens-ministry.jpg" alt="Generic placeholder image">
                </div>
            </div>
            ...
            <div class="row py-5 featurette">
                <div class="col-md-7 ">
                    <h2 class="featurette-heading">Children's Program <span class="text-muted">These are our activities.</span></h2>
        ...
        <div class="text-center">
            <p class="lead">
                Some of the children groups include:
            <ul style="list-style: none;">
                <li class="textcenter">Juniors For Christ</li>
                <li class="textcenter">Lorem, ipsum dolor.</li>
                <li class="textcenter">Lorem, ipsum dolor.</li>

            </ul>

            Do you wish to join the children ministry?For more information call <strong> +254 737 900 477 </strong>
            </p>
        </div>
