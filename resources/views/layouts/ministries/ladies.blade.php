...
<div class="card" style="margin-top: -100px; border-top: 2px solid #fff;" data-aos="slide-down">
        ...
        <h3 class="display-3  card-title mt-5" style="background: rgba(241, 3, 3, 0.7);">Ladies' Ministry</h3>
        </div>
    </div>

<div class="card mx-auto" style="margin-top: -380px; width:60rem;" data-aos="slide-down">
  <img class="card-img" src="img/ladies/doi-3.jpg" alt="Card image cap">
  <div class="card-body">
 ...
 <hr class="featurette-divider">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            ...
            <li>To work for unity of all Christians and with them engage in the common task of building the Kingdom of God
</li>
  ...
  <p class="card-text ml-5 lead">
    Some of the ladies groups include:
    <ul>
