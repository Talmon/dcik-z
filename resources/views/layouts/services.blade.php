...
<div class="row">
        <div class="col-lg-6" style="border-right: 1px solid gray;">
            <div class="card">
                ...
                <div class="card-title display-3">Express Service</div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-title display-3">Celebration Service</div>
                <div class="card-text lead">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi velit quis magnam tempora eaque, iusto doloremque mollitia! Hic quo neque perferendis consequatur modi, autem placeat sint enim optio repellat at?</div>
            </div>
        </div>
    </div>
...
<div class="row">
        <div class="col-lg-6" style="border-right: 1px solid gray;">
            <div class="card">
                ...
                <div class="card-title display-3">Miracle Service</div>
                <div class="card-text lead">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi velit quis magnam tempora eaque, iusto doloremque mollitia! Hic quo neque perferendis consequatur modi, autem placeat sint enim optio repellat at?</div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-title display-3">Revival Meetings</div>
                <div class="card-text lead">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi velit quis magnam tempora eaque, iusto doloremque mollitia! Hic quo neque perferendis consequatur modi, autem placeat sint enim optio repellat at?</div>
            </div>
        </div>
    </div>
